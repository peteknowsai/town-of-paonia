...
// The default hero: the next Board meeting (whatever kind it is). The date is
// the visual focal point. Two big actions: understand the meeting, and see the
// agenda on the Town portal.
export default function NextMeetingHero({ meeting }: { meeting: Meeting }) {
  ...
  return (
    <section className="next" aria-label="Next meeting">
      <p className="eyebrow">Next town meeting</p>
      ...
      <p className="next-foot">
        Regular meetings are the 2nd and 4th Tuesday at 6:30 PM. Work sessions and
        special meetings are added as needed.
      </p>
    </section>
  );
}
